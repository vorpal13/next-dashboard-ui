...
export const calendarEvents = [
  {
    title: 'Math',
    allDay: false,
    start: new Date(2024, 11, 4, 8, 0),
    end: new Date(2024, 11, 4, 8, 45),
  },
  {
    title: 'English',
    allDay: false,
    start: new Date(2024, 11, 4, 9, 0),
    end: new Date(2024, 11, 4, 9, 45),
  },
  {
    title: 'Physics',
    allDay: false,
    start: new Date(2024, 11, 4, 11, 0),
    end: new Date(2024, 11, 4, 11, 45),
  },
  {
    title: 'Chemistry',
    allDay: false,
    start: new Date(2024, 11, 4, 13, 0),
    end: new Date(2024, 11, 4, 13, 45),
  },
  {
    title: 'History',
    allDay: false,
    start: new Date(2024, 11, 4, 14, 0),
    end: new Date(2024, 11, 4, 14, 45),
  },
  {
    title: 'Math',
    allDay: false,
